...
public class ApplyOrderGoodsSkuVo {
    ...
    public ApplyOrderGoodsSkuVo() {
    }

    public ApplyOrderGoodsSkuVo(@NotNull(message = CommonResponse.MESSAGE3) Integer storeId, String applyOrderId) {
