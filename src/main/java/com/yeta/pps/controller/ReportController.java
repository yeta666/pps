...
public class ReportController {
    ...
    public CommonResponse<CommonResult<ReportInventoryVo>> findReportInventoryByGoods(@RequestParam(value = "storeId", required = true) Integer storeId,
        ...
        return reportService.findReportInventoryByGoods(new ReportInventoryVo(storeId, startTime, endTime, id, barCode, typeId), new PageVo(page, pageSize));
    }
    ...
    public CommonResponse<CommonResult<ReportInventoryVo>> findReportInventoryByGoodsWarehouse(@RequestParam(value = "storeId", required = true) Integer storeId,
                                                                                               ...
                                                                                               @RequestParam(value = "page", required = true) Integer page,
                                                                                               @RequestParam(value = "pageSize", required = true) Integer pageSize) {
        return reportService.findReportInventoryByGoodsWarehouse(new ReportInventoryVo(storeId, startTime, endTime, id, barCode, typeId, warehouseId), new PageVo(page, pageSize));
    }
}
